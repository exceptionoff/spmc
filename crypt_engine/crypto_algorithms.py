...
encryptAlg = {"GOST_34_13_128_ECB": EncryptAlgHeader(name="GOST_34_13_128_ECB",
                                                     key_len=32,
                                                     block_len=16,
                                                     iv_size=0,
...
EncryptAlgProgramId_to_Name = {EncryptAlg.program_id: EncryptAlg.name for EncryptAlg in encryptAlg.values()}
